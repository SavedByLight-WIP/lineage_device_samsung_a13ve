...
#BOARD_SYSTEMSDK_VERSIONS := system_current
...
# Camera (from dump - multiple camera services)
PRODUCT_PACKAGES += \
...
# Sensors (from dump - multiple sensors)
PRODUCT_PACKAGES += \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/idc/touchscreen.idc:$(TARGET_COPY_OUT_VENDOR)/usr/idc/touchscreen.idc
